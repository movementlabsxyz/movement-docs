...
# DApp Builder
Movement provides builders with 2 networks and development environments based on Aptos Move or Solidity (Move-EVM). For this reason, you can use wallets and interact with users through 2 networks: EVM (such as MetaMask) and Aptos network (such as Petra, etc.).

# Aptos Move Provides
With the Aptos network, you can use @aptos-labs/wallet-adapter-react to provide your dApp with a `Provider` and `Context` for connecting MoveVM wallets to your dapp.
...
In this example, I'll be using Next.js and TypeScript.

Would you like me to provide the code example for implementing the Provider and Context in Next.js with TypeScript?
