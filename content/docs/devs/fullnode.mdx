---
title: Full Node
description: Full Node for the Movement Network
---
...
```bash tab="Devnet"
export MAPTOS_DA_SEQUENCER_CONNECTION_URL=https://da-sequencer.devnet.movementinfra.xyz
```

```bash tab="Testnet"
export MAPTOS_DA_SEQUENCER_CONNECTION_URL=https://da-sequencer.testnet.movementinfra.xyz
```
...
```bash tab="Devnet"
export MAPTOS_CHAIN_ID=27 && export MAPTOS_PRIVATE_KEY=random
```

```bash tab="Testnet"
export MAPTOS_CHAIN_ID=250 && export MAPTOS_PRIVATE_KEY=random
```

```bash tab="Mainnet"
export MAPTOS_CHAIN_ID=126 && export MAPTOS_PRIVATE_KEY=random
```
...
```bash tab="Devnet"
$HOME/movement/docs/movement-node/run-fullnode/scripts/devnet/restore.sh
```

```bash tab="Testnet"
$HOME/movement/docs/movement-node/run-fullnode/scripts/testnet/restore.sh
```

```bash tab="Mainnet"
$HOME/movement/docs/movement-node/run-fullnode/scripts/mainnet/restore.sh
```
...
```bash tab="Devnet"
curl https://full.devnet.movementinfra.xyz/v1
```
