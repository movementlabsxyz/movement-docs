...
```bash tab="npm"
npm install @aptos-labs/wallet-adapter-react @moveindustries/ts-sdk
```

```bash tab="pnpm"
pnpm add @aptos-labs/wallet-adapter-react @moveindustries/ts-sdk
```

```bash tab="yarn"
yarn add @aptos-labs/wallet-adapter-react @moveindustries/ts-sdk
```

```bash tab="bun"
bun add @aptos-labs/wallet-adapter-react @moveindustries/ts-sdk
```
...
import { MovementConfig, Network } from "@moveindustries/ts-sdk";
