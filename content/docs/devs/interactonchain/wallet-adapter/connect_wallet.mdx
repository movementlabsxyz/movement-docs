...
```bash tab="npm"
npm install @aptos-labs/wallet-adapter-react @movement-network/ts-sdk
```

```bash tab="pnpm"
pnpm add @aptos-labs/wallet-adapter-react @movement-network/ts-sdk
```

```bash tab="yarn"
yarn add @aptos-labs/wallet-adapter-react @movement-network/ts-sdk
```

```bash tab="bun"
bun add @aptos-labs/wallet-adapter-react @movement-network/ts-sdk
```


### Implement Wallet Provider & Custom network
Create a new files with name `provider/WalletProvider.tsx`, import the Aptos Wallet Adapter and any legacy wallet plugins & custom network to connect to the Movement Testnet.

```typescript title="src/provider/WalletProvider.tsx"
import { AptosWalletAdapterProvider } from "@aptos-labs/wallet-adapter-react";
import { PropsWithChildren } from "react";
import { MovementConfig, Network } from "@movement-network/ts-sdk";
