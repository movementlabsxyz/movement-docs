...
To ensure smooth communication, wallets must speak a common language. This is defined by the `AptosWallet` interface, as specified in AIP-62. Think of it as a contract that all wallets must adhere to.
