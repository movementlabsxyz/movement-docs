...
- `@movement-network/ts-sdk`: Movement blockchain SDK for interaction with the network
...
```
- Creates a new Movement configuration instance
- Connects to the Movement testnet network
- Initializes the Movement client with the configuration
...
## Important Notes
1. This component requires a connected wallet to function
