...
id: testnet
title: M1 (Testnet)
description: "M1 Testnet"
---

import React from 'react';

Movement Testnet is a native L1 blockchain network that provides a production-like testing environment for developers to build and test applications before deploying to the production networks. Testnet operates as a full [L1 blockchain](/general/l1).
...
| **Validators** | Community + Move Industries |
| **Data Retention** | Permanent |
| **Faucet** | [Get testnet tokens](https://faucet.movementnetwork.xyz/) |

<Callout type="info">
Testnet lets teams confirm applications are compatible with L1 architecture through _**tool validation**_ to ensure development tools work with L1, _**workflow testing**_ to validate deployment and operational workflows, and _**training**_ to familiarize teams with L1 operations.
</Callout>
