...
Movement Network currently runs **Aptos Move** on both Testnet and Devnet, powered by the [Movement L1](/general/l1/what-is-movement-l1) blockchain. 

<Callout type="info">
**Note:** Sui Move and Move EVM (MEVM) have been deprecated and are no longer supported.
</Callout>

Our Testnet and Devnet are running the Movement L1 - a native Layer 1 blockchain built specifically for the Move programming language. Learn more about [Movement L1 architecture and capabilities](/general/l1/what-is-movement-l1).
