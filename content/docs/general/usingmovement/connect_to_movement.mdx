...
Network endpoints and configuration documentation will be available soon.
...
dApps deployed on the Movement Network will work with both Razor and Nightly wallets.
