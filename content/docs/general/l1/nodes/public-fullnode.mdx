---
id: public-fullnode
title: Public Fullnode (PFN)
description: "Complete guide to running Movement public fullnodes (PFNs)"
---

Public fullnodes (PFNs) will allow you to synchronize the state of the Movement blockchain and stay up-to-date. PFNs will replicate the entire state of the blockchain by syncing from VFNs and other PFNs. PFNs will be available for anyone to run and will serve as crucial infrastructure for the Movement ecosystem.

PFNs will enable various use cases including:
...
When PFNs become available, running a PFN will involve:
...
Detailed deployment guides will be published when PFNs are ready for launch.
...
When PFNs become available, comprehensive guides will be provided for various deployment methods.
