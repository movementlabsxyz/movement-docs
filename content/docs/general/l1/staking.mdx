...
See [The Gap](#the-gap) section for a detailed example showing how 5.5 tokens total rewards (5 tokens to user after 0.5 token commission) result in a share price increase from 1.0 to 1.05 TOKEN/SHARE.
...
For additional context, see the [Aptos Staking documentation](https://aptos.dev/network/blockchain/staking) and [Aptos Delegated Staking documentation](https://aptos.dev/network/blockchain/delegated-staking).
