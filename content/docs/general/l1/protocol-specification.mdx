...
The "blockchain trilemma" refers to the challenge of achieving scalability, security, and decentralization simultaneously; most platforms must compromise on one to optimize the others.
...
2. **High-Throughput Consensus**: [Jolteon](https://arxiv.org/abs/2106.10362) lineage, using a 2-chain commit and quadratic view change; optional [Quorum Store](https://forum.aptosfoundation.org/t/aptos-quorum-store-breaking-the-bottleneck/16671)–like dissemination layer for scaling under load.^[Jolteon originated as DiemBFT v4 and is the basis of AptosBFT — see the [Jolteon paper](https://arxiv.org/abs/2106.10362).]  
...
Movement L1 adopts a [Jolteon](https://arxiv.org/abs/2106.10362)-style BFT protocol. Jolteon introduces a 2-chain commit rule and a quadratic view change (pacemaker) to reduce latency and ensure fast recovery. In the happy path it achieves linear message complexity with single-round finality; under stress it remains robust.
