...
This guide describes how to deploy an archival fullnode by building from the Move Industries `aptos-core` source code.
...
Restore blockchain data from Move Industries' public backups using the restore script:
