...
restic is used to restore blockchain data from Move Industries' public backups.
...
Before starting your archival node, restore existing blockchain data from Move Industries' public backups. This is the recommended approach as syncing from genesis would take an extremely long time.
