...
Additionally, to bootstrap your archival node from Move Industries' public backups, you will need:
- **restic** backup tool ([installation instructions](https://restic.net/))

## Bootstrapping from backups

Move Industries provides public backups of archival node data that are updated hourly. This is the fastest way to bootstrap an archival node rather than syncing from genesis.
