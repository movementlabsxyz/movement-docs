...
Because archival nodes maintain complete history, syncing from genesis would take an extremely long time. Move Industries provides public backups that you can use to bootstrap your archival node with existing data.
