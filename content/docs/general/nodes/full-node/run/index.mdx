---
title: "Requirements"
description: "Hardware, network, storage, and port requirements for running a production-grade public fullnode (PFN) on the Movement blockchain."
sidebar:
  label: "Requirements"
---
...
to connect to you. There are different Movement network types, and each network type uses a different port. However,
...
The amount of data stored by Movement PFNs depends on the ledger history (length) of the blockchain and the number of
...
The Movement devnet is currently reset as needed. If you are deploying a devnet PFN, this means that the storage
can be reset (i.e., wiped). See the [#devnet-announcements](https://discord.com/channels/1101576619493167217/1259638353607917589) channel on the [Movement Discord](http://discord.gg/movementlabsxyz).
</Callout>