...
During the initial synchronization of your PFN, there may be a lot of data to transfer. You can monitor state sync progress
...
[Movement explorer page](https://explorer.movementnetwork.xyz/?network=bardock+testnet). If your node is catching up to the highest
...
If the number of outbound connections returned is `0`, then it means your node cannot connect to the Movement blockchain. If this happens to you, follow these steps to resolve the issue:

1. Update your node to the latest release.
...
[devnet_genesis]: https://devnet.movementnetwork.com/genesis.blob

[devnet_waypoint]: https://devnet.movementnetwork.com/waypoint.txt
